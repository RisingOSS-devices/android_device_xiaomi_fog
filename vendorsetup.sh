...
rm -rf vendor/qcom/opensource/data-ipa-cfg-mgr-legacy-um && git clone https://github.com/PixelExperience/vendor_qcom_opensource_data-ipa-cfg-mgr-legacy-um.git vendor/qcom/opensource/data-ipa-cfg-mgr-legacy-um

#sync pe settings
rm -rf packages/resources/devicesettings && git clone https://github.com/parixxshit/android_packages_resources_devicesettings.git packages/resources/devicesettings
